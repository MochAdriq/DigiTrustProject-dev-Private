...
export default function ActivityLogs() {
  ...
  const exportLogs = () => {
    const csvContent = [
      ["Timestamp", "User", "Action", "Target", "Details", "Type", "Status"].join(","),
    ...
    return (
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <p className="text-gray-500">Activity logs are only available for administrators.</p>
        </CardContent>
      </Card>
    )
  }
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-start">
            ...
            <div className="flex gap-2">
              ...
              {(searchTerm || filterType !== "all" || filterStatus !== "all" || dateRange) && (
                ...
                {filteredLogs.length === 0 ? (
                  ...
                  filteredLogs.map((log) => (
                    <TableRow key={log.id} className="hover:bg-gray-50">
                      ...
                      <TableCell className="max-w-xs truncate text-sm text-gray-600">{log.details}</TableCell>
                    </TableRow>
                  ))
                )}
              </TableBody>
